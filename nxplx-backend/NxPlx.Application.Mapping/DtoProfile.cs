    ...
    public class DtoProfile : Profile
    {
        public DtoProfile()
        {
            CreateMap<DbSeriesDetails, SeriesDto>()
                .ForMember(dst => dst.BackdropPath, opt => opt.MapFrom(src => src.BackdropPath))
                .ForMember(dst => dst.PosterPath, opt => opt.MapFrom(src => src.PosterPath))
            ...
            CreateMap<ProductionCompany, ProductionCompanyDto>()
                .ForMember(dst => dst.Logo, opt => opt.MapFrom(src => src.LogoPath));
