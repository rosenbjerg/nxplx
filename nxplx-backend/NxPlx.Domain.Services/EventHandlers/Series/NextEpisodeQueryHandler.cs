...
{
    public class NextEpisodeQueryHandler : IDomainEventHandler<NextEpisodeQuery, NextEpisodeDto?>, IDomainEventHandler<NextEpisodeByFileIdQuery, NextEpisodeDto?>
    {
        private readonly DatabaseContext _context;
        private readonly IDomainEventDispatcher _dispatcher;
        private readonly IMapper _mapper;

        public NextEpisodeQueryHandler(DatabaseContext context, IDomainEventDispatcher dispatcher, IMapper mapper)
        {
            _context = context;
